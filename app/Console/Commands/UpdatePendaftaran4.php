...
class UpdatePendaftaran4 extends Command
{
    ...
    public function handle(Request $request)
    {
        ...
        $textes = strtoupper("MOMENTUM BISNES 2022 (1/5 - 27/5)")."\n"."\n\n"."Today Registration : ".($package5+$package6+$package7+$package8+$package9+$package10+$package11+$package12+$package13+$package14+$package15+$package16)." ( RM".($totalsale6+$totalsale8+$totalsale10+$totalsale12+$totalsale14+$totalsale16)." )"."\n"."General : ".($package5+$package7+$package9+$package11+$package13+$package15+$package17)."\n"."Diamond : ".($package6+$package8+$package10+$package12+$package14+$package16+$package18)."\n\n"
