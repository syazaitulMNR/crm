...
class UpdatePendaftaran4 extends Command
{
    ...
    public function handle(Request $request)
    {
        ...
        $textes = strtoupper("MOMENTUM BISNES 2022 (1/6 - 7/7)")."\n"."\n"."Today Registration : ".($package15+$package16+$package24+$package17+$package18+$package25+$package26+$package27+$package28)." ( RM".($totalsale16+$totalsale24+$totalsale18+$totalsale25+$totalsale27+$totalsale28)." )"."\n"."General : ".($package15+$package17+$package26)."\n"."Xcess : ".($package24+$package25+$package27)."\n"."Diamond : ".($package16+$package18+$package28)."\n\n"
