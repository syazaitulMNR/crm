...
class AdminController extends Controller
{
    ...
    */
    ...
    public function dashboard(){      
        ...
        // dd($ticket);
        return view('admin.dashboard', compact('student','today','monthly','yearly','jan','feb','mar','apr','may','jun','jul','aug','sep','oct','nov','dec','greetings', 'product', 'package', 'registration', 'paidticket', 'freeticket'));
    }
