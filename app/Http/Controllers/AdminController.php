...
class AdminController extends Controller
{
    ...
    */
    ...
    public function dashboard(Request $request){      
        ...
        return view('admin.dashboard', compact('student','today','monthly','yearly', 'product', 'package', 'date_today', 'current_time', 'from', 'to', 'duration', 'registration', 'paidticket', 'freeticket', 'totalregister', 'totalpaid', 'totalfree', 'totalticket', 'registration1', 'paidticket1', 'freeticket1', 'registration2', 'paidticket2', 'freeticket2', 'registration3', 'paidticket3', 'freeticket3',));
    }
