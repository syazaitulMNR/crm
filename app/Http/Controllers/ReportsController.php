...
class ReportsController extends Controller
{
    ...
    */
    ...
    {   
        ...
        $student_id = Student::where('ic', $request->search)->orWhere('first_name', $request->search)->orWhere('last_name', $request->search)->orWhere('email', $request->search)->where('ticket_type', 'paid')->first();
        $stud_id = $student_id->stud_id;

        $ticket = Ticket::where('stud_id','LIKE','%'. $stud_id.'%')->orWhere('ic','LIKE','%'. $request->search .'%')->where('product_id', $product_id)->where('package_id', $package_id)->where('ticket_type', 'paid')->get();
    ...
    {   
        ...
        //get details from search
        $student_id = Student::where('ic', $request->search)->orWhere('first_name', $request->search)->orWhere('last_name', $request->search)->orWhere('email', $request->search)->where('ticket_type', 'free')->first();
        $stud_id = $student_id->stud_id;
