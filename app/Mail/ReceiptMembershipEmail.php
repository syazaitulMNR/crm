...
class ReceiptMembershipEmail extends Mailable
{
    ...
    protected $name, $secondname, $invoice, $membership, $price, $date, $total, $date_receive, $datesum, $invoice_amount, $amount_received, $balance, $balance_due;
     ...
     * @return void
     */
    public function __construct($name, $secondname, $invoice, $membership, $price, $date, $total, $date_receive, $datesum, $invoice_amount, $amount_received, $balance, $balance_due)
    {
        $this->name = $name;
