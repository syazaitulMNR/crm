        ...
        <table class="table table-hover" id="searchTable">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                  <a class="btn btn-dark" href="{{ url('view-participant') }}/{{ $product->product_id }}/{{ $package->package_id }}/{{ $tickets->ticket_id }}/{{ $students->stud_id }}"><i class="fas fa-chevron-right"></i></a>
                </td>
            </tr>
            @endif
            @endif
