            ...
            <div class="row py-3" style="padding-left: 8%">
                ...
                <div class='col-md-8'>     
                    ...
                    <div class="form-group row pl-3">
                        <input type="text" name="date1" id="date1" class="form-control" value="{{ $product->date_from }}" placeholder="From" style="width:47%" required/>
                        &nbsp;&nbsp;&nbsp; To &nbsp;&nbsp;&nbsp;
                        <input type="text" name="date2" id="date2" class="form-control" value="{{ $product->date_to }}" placeholder="To" style="width:47%" required/>
                    </div>
                </div>
                ...
                <div class='col-md-8'>     
                    ...
                    <div class="form-group row pl-3">
                        <input type="time" name="time1" class="form-control" value="{{ $product->time_from }}" style="width:47%"/>
                        &nbsp;&nbsp;&nbsp; To &nbsp;&nbsp;&nbsp;
                        <input type="time" name="time2" class="form-control" value="{{ $product->time_to }}" style="width:47%"/>
                    </div>
                </div>
