...
<div class="row">
  <div class="col-md-12 px-3 py-4">
    <div class="text-center">
        <h3 class="display-4">Pengesahan Anda Telah Berjaya!</h3>
        <p class="lead pt-3">Terima kasih atas respon anda jumpa anda di next journey</p>
        ...
        <div class="py-3" style="font-size: 24px; color: green;">
          <i class="far bi bi-chat-left-text-fill fa-8x text-center"></i>
        </div>
