...
<div class="col-md-12 px-2 py-3">
    <form class="pb-4" id="msform" name="frm" action="{{ url('registernew') }}/{{ $product->product_id }}/{{ $package->package_id }}" method="post" onsubmit="return checkForm(this);">
        @csrf
        <!-- fieldsets -->
        <fieldset>
            <div class="col-md-12">
                ...
                <h3 class="fs-subtitle">Hai! Baru pertama kali join program kami ya? Sila isikan butiran yang berikut.</h3>
                <hr>
            </div>
            
            <div class="col-sm-10 mx-auto py-2">
                <input class="form-control" type="text" id="ic" name="ic" value="{{ $stud_ic }}" readonly/>
            </div>
            <div class="col-sm-10 mx-auto py-2"> 
                <input class="form-control" type="text" id="first_name" name="first_name" placeholder="Nama Pertama" required/>
            </div>
            <div class="col-sm-10 mx-auto py-2"> 
                <input class="form-control" type="text" id="last_name" name="last_name" placeholder="Nama Akhir" required/>
            </div>
            <div class="col-sm-10 mx-auto  py-2"> 
                <input class="form-control" type="email" id="email" name="email" placeholder="Emel *Cth: example@gmail.com" required/>
            </div>
            <div class="col-sm-10 mx-auto py-2">  
                {{-- code --}}
                <input class="form-control" style="width:100% !important;" id="input-phone" type="tel" name="phoneno" value="+60" required/>
                <br>
                <label style="font-size: 10pt; color:rgb(34, 34, 34);"><em>Sila pilih kod negara Cth: *+60 dan isikan no anda *Cth: 1123456789</em></label>
                {{-- code --}}

                {{-- <input class="form-control pb-2" type="tel" id="phoneno" name="phoneno" placeholder="Tanpa '-' *Cth: 601123456789" maxlength="11" required/>--}}
            </div>
        ...
        <fieldset>
            ...
            <input type="button" name="previous" class="previous action-button-previous px-2" value="Previous"/>
            <input type="button" name="next" class="next action-button px-2" value="Next"/>
        </fieldset>
        <fieldset>
            <div class="col-md-12">
