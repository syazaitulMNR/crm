...
<div class="row">
  <div class="col-md-12 px-5 py-4">
    <div class="text-center">
        ...
        <p>Pembelian anda telah berjaya. Sila tonton video ini sampai habis untuk dapatkan info penting untuk tindakan selanjutnya.</p>
        ...
        <p> Pengesahan pembelian akan dihantar kepada emel yang telah didaftarkan dalam masa 48 Jam. Terima kasih kerana menunggu. </p>
        <p>
