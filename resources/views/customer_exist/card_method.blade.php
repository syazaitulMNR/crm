...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12 d-flex justify-content-center pb-5">
            <form action="{{ url('saveCard') }}/{{ $product->product_id }}/{{ $package->package_id }}/{{ $student->stud_id }}" method="POST" onsubmit="return checkForm(this);" data-stripe-publishable-key="pk_test_lrGwlGkyv7dR6xG0pgQ7PFoI00D6Ef6y4Q">
                @csrf
