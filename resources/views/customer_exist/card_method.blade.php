...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12 d-flex justify-content-center pb-5">
            <form action="{{ url('saveCard') }}/{{ $product->product_id }}/{{ $package->package_id }}/{{ $student->stud_id }}" method="POST" onsubmit="return checkForm(this);" data-stripe-publishable-key="pk_live_lNl5S8TossaoQYO0qKwSM5pr004b28isKu">
                @csrf
