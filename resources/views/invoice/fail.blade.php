    ...
    <div class='container-fluid'>
        <div class="d-flex justify-content-center someElement">
            <div class="card" style="width: 30rem; height: 17rem;">
                <div class="card-header" style="background-color: #f01d1d;">
                    <img class="card-img-top" src="/assets/images/close.svg" width="100" height="100" alt="Card image cap">
                </div>
                <div class="card-body text-center">
                    <h4>Something went wrong. Your payment was unsuccessful.</h4>
                    <p class="mb-3">You will be redirected to dashboard shortly.</p>
                </div>
            </div>
        </div>
    </div>
