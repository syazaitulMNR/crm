  ...
  <div class="col-md-12 pt-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('student.link') }}">Event</a></li>
      ...
      <tbody>
        ...
        @if ($product->product_id == $packages->product_id)                    
          <tr>
            ...
            <td>{{ $packages->name  }}</td>
            <td><input type="text" class="form-control" value="{{ $link }}{{ $packages->package_id }}/{{ Session::get('student_login_id') }}" readonly></td>
